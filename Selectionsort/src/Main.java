...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        TextFileWrite writeFile = new TextFileWrite("752652_selection.txt"); //cria arquivo log

        writeFile.write("Numero de trocas entre elementos: " + selectionSortObject.countSwitch + " Numero de movimentacoes no vetor " + selectionSortObject.countCompare + "Matricula: xxxxx Tempo de execução em milisegundos: " + executionTime);
