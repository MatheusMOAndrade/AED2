...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        TextFileWrite writeFile = new TextFileWrite("752652_insercao.txt");

        writeFile.write("Matricula: 752652 \t" + "Tempo de execução em milisegundos: " + executionTime + "\t Numero de trocas entre elementos: " + insertSortObject.countSwitch + "\t Numero de movimentacoes no vetor: " + insertSortObject.countCompare);
