...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        TextFileWrite writeFile = new TextFileWrite("752652_mergesort.txt");

        writeFile.write("Matricula: 752652 \t" + "Tempo de execução em milisegundos: " + executionTime + "\t Numero de trocas entre elementos: " + mergeSortObject.countSwitch + "\t Numero de movimentacoes no vetor: " + mergeSortObject.countCompare);
