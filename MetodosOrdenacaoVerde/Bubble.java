...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        TextFileWrite writeFile = new TextFileWrite("752652_bolha.txt");

        writeFile.write("Matricula: 752652 \t" + "Tempo de execução em milisegundos: " + executionTime + "\t Numero de trocas entre elementos: " + bubbleSortSeries.countSwitch + "\t Numero de movimentacoes no vetor: " + bubbleSortSeries.countCompare);
