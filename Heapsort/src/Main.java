...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        writeFile.write("Numero de trocas entre elementos: " + heapSortObject.countSwitch + " Numero de movimentacoes no vetor " + heapSortObject.countCompare + "Matricula: xxxxx Tempo de execução em milisegundos: " + executionTime);
